...
public class CryptoClient {
        ...
        public CryptoClient(final String keyStorePath, final String trustStorePath, final String password) {
            try {
                ...
                final KeyManagerFactory kmf = initKeyManagerFactory(keyStore, password);

                final SslContextBuilder sslBuilder = SslContextBuilder.forClient().trustManager(tmf).keyManager(kmf);
